...
__all__: list[str] = ["AircraftRoute", "Destination", "Route", "RoutesSearch", "SameOdException"]
...
class AircraftRoute:
    class Options:
        class SortBy:
            ...
            __members__: typing.ClassVar[
                dict[str, AircraftRoute.Options.SortBy]
            ]  # value = {'PER_TRIP': <SortBy.PER_TRIP: 0>, 'PER_AC_PER_DAY': <SortBy.PER_AC_PER_DAY: 1>}
        ...
        class TPDMode:
            ...
            STRICT_ALLOW_MULTIPLE_AC: typing.ClassVar[
                AircraftRoute.Options.TPDMode
            ]  # value = <TPDMode.STRICT_ALLOW_MULTIPLE_AC: 1>
            __members__: typing.ClassVar[
                dict[str, AircraftRoute.Options.TPDMode]
            ]  # value = {'AUTO': <TPDMode.AUTO: 0>, 'STRICT_ALLOW_MULTIPLE_AC': <TPDMode.STRICT_ALLOW_MULTIPLE_AC: 1>, 'STRICT': <TPDMode.STRICT: 2>}
            def __eq__(self, other: typing.Any) -> bool: ...
            def __getstate__(self) -> int: ...
            def __hash__(self) -> int: ...
            def __index__(self) -> int: ...
        ...
        def __init__(
            self,
            tpd_mode: AircraftRoute.Options.TPDMode = TPDMode.AUTO,
        ...
        def max_flight_time(self, arg0: typing.SupportsFloat) -> None: ...
        @property
        def min_distance(self) -> float: ...
        @min_distance.setter
        def min_distance(self, arg0: typing.SupportsFloat) -> None: ...
        @property
        def min_flight_time(self) -> float: ...
        @min_flight_time.setter
        def min_flight_time(self, arg0: typing.SupportsFloat) -> None: ...
        @property
        def trips_per_day_per_ac(self) -> int: ...
        @trips_per_day_per_ac.setter
        def trips_per_day_per_ac(self, arg0: typing.SupportsInt) -> None: ...
    ...
    class Warning:
        ...
        ERR_DISTANCE_ABOVE_SPECIFIED: typing.ClassVar[
            AircraftRoute.Warning
        ]  # value = <Warning.ERR_DISTANCE_ABOVE_SPECIFIED: 1>
        ERR_DISTANCE_BELOW_SPECIFIED: typing.ClassVar[
            AircraftRoute.Warning
        ]  # value = <Warning.ERR_DISTANCE_BELOW_SPECIFIED: 2>
        ...
        ERR_FLIGHT_TIME_ABOVE_SPECIFIED: typing.ClassVar[
            AircraftRoute.Warning
        ]  # value = <Warning.ERR_FLIGHT_TIME_ABOVE_SPECIFIED: 7>
        ERR_FLIGHT_TIME_BELOW_SPECIFIED: typing.ClassVar[
            AircraftRoute.Warning
        ]  # value = <Warning.ERR_FLIGHT_TIME_BELOW_SPECIFIED: 8>
        ...
        ERR_TRIPS_PER_DAY_TOO_HIGH: typing.ClassVar[
            AircraftRoute.Warning
        ]  # value = <Warning.ERR_TRIPS_PER_DAY_TOO_HIGH: 10>
        REDUCED_CONTRIBUTION: typing.ClassVar[AircraftRoute.Warning]  # value = <Warning.REDUCED_CONTRIBUTION: 5>
        __members__: typing.ClassVar[
            dict[str, AircraftRoute.Warning]
    ...
    @typing.overload
    def calc_co2(
        ac: am4.utils.aircraft.Aircraft,
        cfg: am4.utils.aircraft.Aircraft.PaxConfig,
        distance: typing.SupportsFloat,
        user: am4.utils.game.User = am4.utils.game.User.Default(),
        ci: typing.SupportsInt = 200,
    ) -> float: ...
    @staticmethod
    @typing.overload
    def calc_co2(
        ac: am4.utils.aircraft.Aircraft,
        cfg: am4.utils.aircraft.Aircraft.CargoConfig,
        distance: typing.SupportsFloat,
        user: am4.utils.game.User = am4.utils.game.User.Default(),
        ci: typing.SupportsInt = 200,
    ) -> float: ...
    ...
    @staticmethod
    def create(
        ap0: am4.utils.airport.Airport,
        ap1: am4.utils.airport.Airport,
        ac: am4.utils.aircraft.Aircraft,
        options: AircraftRoute.Options = AircraftRoute.Options(),
        user: am4.utils.game.User = am4.utils.game.User.Default(),
    ) -> AircraftRoute: ...
    @staticmethod
    def estimate_load(
        reputation: typing.SupportsFloat = 87, autoprice_ratio: typing.SupportsFloat = 1.06, has_stopover: bool = False
    ) -> float: ...
    def __repr__(self) -> str: ...
    def to_dict(self) -> dict: ...
    @property
...
class Route:
    ...
    @typing.overload
    def calc_distance(
        lat1: typing.SupportsFloat, lon1: typing.SupportsFloat, lat2: typing.SupportsFloat, lon2: typing.SupportsFloat
    ) -> float: ...
    @staticmethod
    @typing.overload
...
class RoutesSearch:
    def __init__(
        self,
        ap0: collections.abc.Sequence[am4.utils.airport.Airport],
        ac: am4.utils.aircraft.Aircraft,
        options: AircraftRoute.Options = AircraftRoute.Options(),
        user: am4.utils.game.User = am4.utils.game.User.Default(),
    ) -> None: ...
    def _get_columns(
        self, dests: collections.abc.Sequence[Destination], include_origin: bool = False
    ) -> dict[str, list]: ...
    def _get_sell_columns(
        self, dests: collections.abc.Sequence[Destination], include_origin: bool = False
    ) -> dict[str, list]: ...
    def get(self) -> list[Destination]: ...
    def get_sell(self) -> list[Destination]: ...
