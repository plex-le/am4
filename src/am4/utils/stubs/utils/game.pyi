...
import typing
__all__: list[str] = ['Campaign', 'User']
class Campaign:
    class Airline:
        """
        Members:
    ...
    def parse(s: str) -> Campaign:
        ...
    def estimate_cargo_reputation(self, base_reputation: typing.SupportsFloat = 45) -> float:
        ...
    def estimate_pax_reputation(self, base_reputation: typing.SupportsFloat = 45) -> float:
        ...
    @property
...
class User:
    ...
    def accumulated_count(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def cargo_load(self) -> float:
        ...
    @cargo_load.setter
    def cargo_load(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def co2_price(self) -> int:
        ...
    @co2_price.setter
    def co2_price(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def co2_training(self) -> int:
        ...
    @co2_training.setter
    def co2_training(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def discord_id(self) -> int:
        ...
    @discord_id.setter
    def discord_id(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def fuel_price(self) -> int:
        ...
    @fuel_price.setter
    def fuel_price(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def fuel_training(self) -> int:
        ...
    @fuel_training.setter
    def fuel_training(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def game_id(self) -> int:
        ...
    @game_id.setter
    def game_id(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def h_training(self) -> int:
        ...
    @h_training.setter
    def h_training(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def id(self) -> str:
        ...
    ...
    def income_loss_tol(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def l_training(self) -> int:
        ...
    @l_training.setter
    def l_training(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def load(self) -> float:
        ...
    @load.setter
    def load(self, arg0: typing.SupportsFloat) -> None:
        ...
    @property
    def repair_training(self) -> int:
        ...
    @repair_training.setter
    def repair_training(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def wear_training(self) -> int:
        ...
    @wear_training.setter
    def wear_training(self, arg0: typing.SupportsInt) -> None:
        ...
